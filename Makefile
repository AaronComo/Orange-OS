...
ASMKFLAGS	= -I include/ -I include/sys/ -f elf -gdwarf 
CFLAGS		= -I include/ -I include/sys/ -c -fno-builtin -Wall -m32 -fno-stack-protector -g1
LDFLAGS		= -Ttext $(ENTRYPOINT) -m elf_i386 -z noexecstack
DASMFLAGS	= -D
ARFLAGS		= rcs
...
buildimg :
	...
	orb sudo mount -o loop $(FD) /mnt/test
